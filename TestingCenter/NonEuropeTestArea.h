...
{
public:
	/// @brief Constructor for EuropeTestArea
	/// @param wc is the windtunnelcounter pointer. Only one pointer per season
	NonEuropeTestArea(WindTunnelCounter* wc) :TestingCenter(wc) {};
